...
[Mysql 练习题](https://note.youdao.com/ynoteshare1/index.html?id=45d4298f42397bd52ccf6fc716e27ee9&type=note#/)
...
2. 查询平均绩大于等于 60 分的同学的学生编号和学生姓名和平均成绩
...
select SC.SId, sum(sc.score) as sumscore, 
    count(sc.CId) as coursecount from sc
